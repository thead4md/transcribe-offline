  ...
  return (
    <div style={{ minHeight: '100dvh', display: 'flex', flexDirection: 'column', background: 'var(--bg)' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-3)' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 'var(--text-xs)', color: 'var(--text-muted)', fontFamily: 'var(--font-mono)', display: 'flex', alignItems: 'center', gap: '6px' }}>
              <Cpu size={11} />
              Offline · Apple Silicon · mlx-whisper
            </div>
          </div>
        </div>
          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{ fontSize: 'var(--text-xs)', opacity: 0.8, marginTop: '2px' }}>
                Indítsd el a szervert: <code style={{ background: 'rgba(0,0,0,0.3)', padding: '1px 6px', borderRadius: '3px' }}>python server.py</code>
              </div>
            </div>
          </div>
        )}
            ...
            {isProcessing && inputMode === 'upload' && (
              <div className="animate-fade-in" style={{
                ...
                <div style={{ textAlign: 'center' }}>
                  ...
                  <div style={{ fontSize: 'var(--text-xs)', color: 'var(--text-muted)', fontFamily: 'var(--font-mono)' }}>
                    {selectedFile?.name} · {modelShort} · Apple Silicon
                  </div>
                </div>
      ...
      <footer style={{
        ...
        <div style={{ fontSize: 'var(--text-xs)', color: 'var(--text-muted)', fontFamily: 'var(--font-mono)', display: 'flex', alignItems: 'center', gap: '6px' }}>
          <Cpu size={11} />
          100% offline · mlx-whisper · {modelShort} · Apple Silicon
        </div>
        <a
